...
class Attention(nn.Module):
    ...
    def forward(self, pos_emb = None, context = None, mask = None, context_mask = None, query = None, key = None, value = None, **kwargs):
        x  = torch.cat([query, key, value], dim=-1)
        b, n, _, h, gh = *value.shape, self.heads, self.global_heads
