...
def valid_feature_type(feature_type):
  bool1 = feature_type in ['relu', 'elu+1', 'sqr', 'favor+_']
...
class MultiHeadAttention(torch.nn.Module):
  ...
  def forward(self, x, rfs, queries = None, keys = None, values = None):

    # if queries is None and keys is None and values is None:
